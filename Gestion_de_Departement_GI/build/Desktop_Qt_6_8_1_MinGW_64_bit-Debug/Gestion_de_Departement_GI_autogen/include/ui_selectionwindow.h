...
"         "));
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/assets/professor.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
...
"         "));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/assets/document.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
...
"            "));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/assets/calendar.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
...
"font-family: 'Roboto', sans-serif;"));
        ...
        masterButton->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
...
"}"));
        ...
        licenceButton->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
...
"}"));
        ...
        engineerButton->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
