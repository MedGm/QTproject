...
namespace {
struct qt_meta_tag_ZN16ProfessorsWindowE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN16ProfessorsWindowE = QtMocHelpers::stringData(
    "ProfessorsWindow",
...
Q_CONSTINIT static const uint qt_meta_data_ZN16ProfessorsWindowE[] = {
...
Q_CONSTINIT const QMetaObject ProfessorsWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN16ProfessorsWindowE.offsetsAndSizes,
    qt_meta_data_ZN16ProfessorsWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16ProfessorsWindowE_t,
        // Q_OBJECT / Q_GADGET
...
void *ProfessorsWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN16ProfessorsWindowE.stringdata0))
