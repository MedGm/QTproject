...
static constexpr auto qt_meta_stringdata_ZN15SelectionWindowE = QtMocHelpers::stringData(
    "SelectionWindow",
...
Q_CONSTINIT static const uint qt_meta_data_ZN15SelectionWindowE[] = {
...
Q_CONSTINIT const QMetaObject SelectionWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15SelectionWindowE.offsetsAndSizes,
    qt_meta_data_ZN15SelectionWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15SelectionWindowE_t,
        // Q_OBJECT / Q_GADGET
...
void *SelectionWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15SelectionWindowE.stringdata0))
