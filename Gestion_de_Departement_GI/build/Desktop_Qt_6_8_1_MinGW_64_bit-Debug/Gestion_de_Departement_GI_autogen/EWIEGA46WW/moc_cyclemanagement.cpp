...
namespace {
struct qt_meta_tag_ZN15cyclemanagementE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN15cyclemanagementE = QtMocHelpers::stringData(
    "cyclemanagement",
    "onLevelChanged",
    "",
    "index",
...
Q_CONSTINIT static const uint qt_meta_data_ZN15cyclemanagementE[] = {
...
Q_CONSTINIT const QMetaObject cyclemanagement::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15cyclemanagementE.offsetsAndSizes,
    qt_meta_data_ZN15cyclemanagementE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15cyclemanagementE_t,
        // Q_OBJECT / Q_GADGET
...
void *cyclemanagement::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15cyclemanagementE.stringdata0))
