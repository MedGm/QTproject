...
namespace {
struct qt_meta_stringdata_cyclemanagement_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_cyclemanagement_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_cyclemanagement_t qt_meta_stringdata_cyclemanagement = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_cyclemanagement[] = {
...
Q_CONSTINIT const QMetaObject cyclemanagement::staticMetaObject = { {
    ...
    qt_meta_stringdata_cyclemanagement.offsetsAndSizes,
    qt_meta_data_cyclemanagement,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_cyclemanagement_t,
        // Q_OBJECT / Q_GADGET
...
void *cyclemanagement::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cyclemanagement.stringdata0))
