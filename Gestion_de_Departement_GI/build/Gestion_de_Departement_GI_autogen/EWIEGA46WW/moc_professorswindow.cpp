...
namespace {
struct qt_meta_stringdata_ProfessorsWindow_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ProfessorsWindow_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_ProfessorsWindow_t qt_meta_stringdata_ProfessorsWindow = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_ProfessorsWindow[] = {
...
Q_CONSTINIT const QMetaObject ProfessorsWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ProfessorsWindow.offsetsAndSizes,
    qt_meta_data_ProfessorsWindow,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_ProfessorsWindow_t,
        // Q_OBJECT / Q_GADGET
...
void *ProfessorsWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ProfessorsWindow.stringdata0))
