...
"}"));
        ...
        topSpacer = new QSpacerItem(20, 100, QSizePolicy::Expanding, QSizePolicy::Minimum);
...
"}"));
        ...
        bottomSpacer = new QSpacerItem(20, 150, QSizePolicy::Expanding, QSizePolicy::Minimum);
