...
struct qt_meta_stringdata_CLASSReservationsWindowENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSReservationsWindowENDCLASS = QtMocHelpers::stringData(
    "ReservationsWindow",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSReservationsWindowENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSReservationsWindowENDCLASS_t qt_meta_stringdata_CLASSReservationsWindowENDCLASS = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_CLASSReservationsWindowENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ReservationsWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSReservationsWindowENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSReservationsWindowENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSReservationsWindowENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *ReservationsWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSReservationsWindowENDCLASS.stringdata0))
